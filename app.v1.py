...
THRESHOLDS = {
    "p10": 1.0000, "p35": 0.07133333333333333, "p50": 1.3740, "p70": 0.16719999999999996,
    "p90": 0.25099999999999995, "p95": 2.2911, "p99":0.5652399999999999
}
...
df_map = pd.read_csv("county_mean_scores_all.csv")
...
# ================================
    ...
    scenario_map = {
        ...
        "Scenario 2 — 95% do not use plastic containers in microwave": "Decrease_95",
